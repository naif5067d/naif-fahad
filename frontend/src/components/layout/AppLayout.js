...
import { LayoutDashboard, FileText, CalendarDays, Clock, FileSignature, Users, Settings, Shield, Menu, X, Sun, Moon, Globe, ChevronDown, Check, MapPin, Package, Wallet, Wrench, FileCheck, Receipt, AlertTriangle, UsersRound, LogOut, History, ClipboardList, Hammer, Activity, Maximize, Minimize, ClipboardCheck, Book } from 'lucide-react';
...
const PATHS = {
  ...
  executive: '/executive', ats: '/ats', policies: '/policies',
};
