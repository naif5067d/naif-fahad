...
import { LayoutDashboard, FileText, CalendarDays, Clock, FileSignature, Users, Settings, Shield, Menu, X, Sun, Moon, Globe, ChevronDown, Check, MapPin, Package, Wallet, Wrench, FileCheck, Receipt, AlertTriangle, UsersRound, LogOut, History, ClipboardList, Hammer } from 'lucide-react';
...
const ICONS = {
  ...
  attendancePenalties: UsersRound, loginSessions: History, tasks: ClipboardList,
};
...
const PATHS = {
  ...
  attendancePenalties: '/team-attendance', loginSessions: '/login-sessions', tasks: '/tasks',
};
