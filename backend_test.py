...
class DarAlCodeAPITester:
    def __init__(self, base_url="https://smart-attendance-gov.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Backend URL: https://smart-attendance-gov.preview.emergentagent.com")
    print("=" * 60)
