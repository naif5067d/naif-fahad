...
class DarAlCodeAPITester:
    def __init__(self, base_url="https://rbac-transaction-sys.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Backend URL: https://rbac-transaction-sys.preview.emergentagent.com")
    print("=" * 60)
