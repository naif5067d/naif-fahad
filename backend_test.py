...
class DarAlCodeAPITester:
    def __init__(self, base_url="https://workflow-stabilize-1.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Backend URL: https://workflow-stabilize-1.preview.emergentagent.com")
    print("=" * 60)
