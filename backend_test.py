...
class DarAlCodeAPITester:
    def __init__(self, base_url="https://language-unification.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Backend URL: https://language-unification.preview.emergentagent.com")
    print("=" * 60)
